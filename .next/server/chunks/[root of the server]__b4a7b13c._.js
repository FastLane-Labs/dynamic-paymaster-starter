    ...
    try {
        ...
        switch(method){
            case 'backend_getSignature':
                ...
                const packedUserOp = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$viem$2f$account$2d$abstraction__$5b$external$5d$__$28$viem$2f$account$2d$abstraction$2c$__esm_import$29$__["toPackedUserOperation"])(userOpObject);
                console.log("Backend packedUserOp", packedUserOp);
                console.log("Backend gasFees", userOp.gasFees);
                try {
                    const signature = await handleGetSignature(packedUserOp, validUntilBigInt, validAfterBigInt, paymasterAddress, chainIdBigInt);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b4a7b13c._.js.map