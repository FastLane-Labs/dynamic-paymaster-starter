import { publicClient, smartAccount } from "@/lib/fastlane/user";
...
const demoErc20UserIsSelling = getContract({
    address: constants.USER_SELL_TOKEN_ADDRESS as Hex,
    abi: demoErc20Abi,
    client: {
        public: publicClient,
        account: smartAccount,
...
const demoErc20UserIsBuying = getContract({
    address: constants.USER_BUY_TOKEN_ADDRESS as Hex,
    abi: demoErc20Abi,
    client: {
        public: publicClient,
        account: smartAccount,
